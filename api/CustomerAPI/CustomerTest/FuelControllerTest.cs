...
namespace Fuel.API.UnitTest
{
    ...
    public class FuelControllerTest
    {
        ...
        */
        ...
        public async Task FuelQuote(string username, string password)
        {
        ...
        public async Task getHistory(string username, string password)
        {
        ...
        [TestCase("usernameLogin", "passwordLogin")]
        public async Task getHistory_NoHistory(string username, string password)
        {
            //Arrage: Create injection 
            Mock<IAuthRepository> mockIAuthRepository = new Mock<IAuthRepository>();
            Mock<IConfiguration> mockIConfig = new Mock<IConfiguration>();
        ...
        public static User Add_SimpleAdd(string username, string password)
        {
            var user = new User()
            {
                UserId = 1,
